...
%    bottom=8pt
%]
%{\small{\color{lightpurple}\faQuestionCircle}\quad \textbf{宏基因组报告和16s报告的区别是什么？}\\
%{\color{orange!50}\faComments}\quad 肠道菌群的宏基因组报告和16S rRNA基因测序报告在技术方法、结果内容和应用方面具有显著的区别。
%\begin{itemize}
%    \item \textbf{测序技术}
%    \begin{itemize}
%        \item 宏基因组：使用高通量测序技术对整个微生物群落的基因组进行测序。
%        \item 16s：专注于测序细菌和古菌中的16S rRNA基因。
%    \end{itemize}
%    \item \textbf{数据内容}
%    \begin{itemize}
%        \item 宏基因组：提供全基因组的信息，包括微生物的种类、丰度、功能潜力，以及它们之间的相互作用。能够识别主要的代谢通路、潜在的酶功能和生物活性化合物等。
%        \item 16s：主要提供细菌或古菌的分类信息（如属和种），以及各类微生物的相对丰度。无法提供有关微生物功能的深入信息，因为仅分析单一的16S rRNA基因。
%    \end{itemize}
%    \item \textbf{微生物范围}
%    \begin{itemize}
%        \item 宏基因组：能够全面分析样本中的所有微生物，包括细菌、古菌、真菌和病毒，从而提供更全面的微生物群落特征。
%        \item 16s：仅限于细菌和古菌，无法提供真菌、病毒等其他微生物的相关信息。
%    \end{itemize}
%    \item \textbf{应用}
%    \begin{itemize}
%        \item 宏基因组：适用于需要深入了解微生物群落功能、代谢途径、相互作用及其对宿主健康的全面影响的研究。
%        \item 16s：适用于初步了解肠道微生物组成和多样性，特别是在较大研究项目中的筛选和监测。
%    \end{itemize}
%\end{itemize}
%}
%\end{tcolorbox}
...
{\small{\textcolor{yellow!85!orange}{\faLightbulb}}\quad 检测到的主要病毒及其特点：
\begin{itemize}
    \item 分枝杆菌噬菌体Echild：一种专门感染分枝杆菌的病毒，通过调控宿主菌的数量来维持菌群平衡。
    \item 草履虫绿藻病毒1号：常见的水生环境病毒，可能通过饮食进入肠道，对人体无害。
    \item 人内源性反转录病毒K：人类基因组的组成部分，在进化过程中整合入人类DNA，通常处于沉默状态。
    \item Cbastvirus ST和Shalavirus Shbh1：新发现的病毒类型，目前研究表明在正常范围内对人体健康无明显影响。
\end{itemize}

{\textcolor{green!85!orange}{\faLightbulb}}\quad 检测结果显示，所有病毒的丰度都维持在正常范围（0-0.05\%）内，表明您的肠道病毒群处于稳定和健康的状态，这种平衡有助于维持肠道微生态系统的正常运作。
}
\end{tcolorbox}
...
{\small{\textcolor{yellow!85!orange}{\faLightbulb}}\quad 代谢指标严重偏低需要重点关注：
\begin{itemize}
...
{\textcolor{green!85!orange}{\faLightbulb}}\quad 建议：
\begin{itemize}
\item 及时就医进行专业评估和干预
\item 调整饮食结构，避免高草酸食物
...
\node[text width=0.38\textwidth, font=\small, align=left]
    at (-0.25\textwidth,2.5) {在绝大多数健康人群肠道中普遍存在的优势菌属，包括厚壁菌属、拟杆菌属等，占据总菌群的主要组成部分。};

% 非核心重要菌属卡片
\node[leftcard, fill=nonCoreColor] at (-0.25\textwidth,-4.5) {};
\node[font=\Large\bfseries] at (-0.19\textwidth - 0.15\textwidth,-2.2) {非核心重要菌属};
\node[text width=0.38\textwidth, font=\small, align=left]
    at (-0.25\textwidth,-6) {虽然丰度相对较低，但对维持肠道健康具有重要作用的菌属，如乳酸菌属、双歧杆菌属等。};
...
\begin{tikzpicture}[
    ...
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {梭菌属}/{Clostridium}/1.90370/{0-4.464}/67\%/99.52\%/正常/{梭菌属是肠道中的重要菌群，参与碳水化合物代谢，免疫调节等，在肠道中发挥重要作用}/{}/\currentpos,
        {普雷沃氏菌属}/{Prevotella}/0.04290/{0-67.8009}/50\%/99.52\%/正常/{该菌属具有降解植物多糖和黏蛋白的能力，在肠道中参与碳水化合物代谢，是维持肠道健康的重要菌群}/{}/\currentpos,
        {瘤胃球菌属}/{Ruminococcus}/9.84521/{0.0544-19.7985}/44\%/99.52\%/正常/{消化纤维素菌群，纤维素代谢和降解的重要菌群，能够产生短链脂肪酸，维持肠道健康}/{}/\currentpos,
        {拟杆菌属}/{Bacteroides}/0.08974/{1.0578-47.3225}/2\%/99.04\%/偏低/{重要的肠道共生菌，参与碳水化合物代谢，维持肠道稳态，产生短链脂肪酸}/{建议增加膳食纤维摄入，如全谷物、蔬菜水果等}/\currentpos,
        {真杆菌属}/{Eubacterium}/5.75186/{0.1146-9.4883}/95\%/98.56\%/正常/{产生短链脂肪酸，参与胆固醇代谢，具有抗炎作用，维持肠道健康}/{}/\currentpos,
        {乳酸杆菌属}/{Lactobacillus}/0.00660/{0-0.4302}/8\%/91.83\%/正常/{重要的益生菌，参与碳水化合物代谢，产生乳酸，维持肠道健康}/{}/\currentpos,
        {芽孢杆菌属}/{Bacillus}/ND/{0.0001-0.5535}/27\%/77.88\%/未检出/{具有益生功能，可产生多种酶类和抗菌物质，增强免疫力}/{建议适当补充含芽孢杆菌的益生菌制剂}/\currentpos,
        {Lachnoclostridium}/{Lachnoclostridium}/0.17516/{0-0.2086}/8\%/98.56\%/正常/{厌氧菌，与肠道健康密切相关，参与多糖代谢，产生短链脂肪酸，为肠道提供营养}/{}/\currentpos
%        {粪杆菌属}/{Faecalibacterium}/28.86665/{1.9351-17.7942}/99\%/98.08\%/超标/{重要的益生菌，产生丁酸，具有抗炎作用，维持肠道健康，与多种疾病相关}/{建议适当调整饮食结构，增加膳食纤维摄入}/\currentpos,
%        {戴阿利斯特杆菌属}/{Dialister}/2.74325/{0-3.7365}/79\%/96.15\%/正常/{代谢碳水化合物，产生短链脂肪酸，与多种肠道疾病相关，在肠道微生态中起重要作用}/{}/\currentpos,
%        {罗氏菌属}/{Roseburia}/6.33667/{0.583-16.3581}/10\%/96.15\%/正常/{产生丁酸，抗炎，维持肠道健康，与多种疾病相关}/{}/\currentpos
%        {阿加莎菌属}/{Agathobacter}/0.00038/{0-8.6328}/27\%/95.67\%/正常/{可利用抗性淀粉，参与碳水化合物代谢，和肠道健康相关}/{}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {粪杆菌属}/{Faecalibacterium}/28.86665/{1.9351-17.7942}/99\%/98.08\%/正常/{基石菌，丁酸生产菌，下一代益生菌，抗炎，慢性便秘、乳糜泻、肠易激综合征和炎性肠病中减少，维持肠道稳态，抑制病原菌，与拟杆菌，青霉双歧杆菌等交叉调节，生产B12，缓解过敏，改善肝脏健康，远离焦虑等可以增加其丰度。}/{建议：乳杆菌补充、亚麻籽、壳聚糖、柿子糖（甜栗）}/\currentpos,
        {经黏液真杆菌属}/{Blautia}/10.17279/{0.0846-6.9056}/75\%/97.60\%/超标/{消化复合碳水化合物，健康菌，偏低与炎症疾病，营养不良相关，减肥有效果，缓解炎症性疾病和代谢疾病，抑制病原菌，老年，氟喹诺酮和环丝氨酸饮酒会减少，参与实菌群，差异素生物转化}/{建议：高胆汁酸、红酒、啤酒}/\currentpos,
        {戴阿利斯特杆菌属}/{Dialister}/2.74325/{0-3.7365}/79\%/96.15\%/正常/{代谢碳水化合物，产短链脂肪酸，许多种都可能导致感染，但是抑制症感者缺乏，关节炎恶者富集，与强直性脊柱炎正相关，癌症患者样本中显著升高，丰度高难以减肥，油炸食品会增加其丰度}/{}/\currentpos,
        {罗氏菌属}/{Roseburia}/6.33667/{0.583-16.3581}/10\%/96.15\%/正常/{基石菌，产丁酸，丙酸，乙酸，影响结肠运动，具抗炎特性，分解不可消化的碳水化合物，百岁老人富集，抗炎，IBD和IBS，直肠癌，代谢类疾病患者减少，与神经、免疫，过敏相关，缺乏加剧疾病，过多也会导致菌群失衡，与含碳水化合物会促进其生长，例如菌落，燕麦，青香蕉等}/{}/\currentpos,
        {直肠真杆菌属}/{Agathobacter}/0.00038/{0-8.6328}/27\%/95.67\%/正常/{可利用抗性淀粉，个别研究报道与结直肠癌愈后恢复，抑制症康复有关}/{}/\currentpos,
        {吉米菌属}/{Gemmiger}/0.18163/{0.0038-0.973}/9\%/95.67\%/正常/{健康饮食，高果蔬、谷物及豆类饮食含量高，与维激素分泌相关，缓解便秘，与脂肪堆积分布负相关，双相情感障碍和抑郁，阿尔兹海默症患者丰度降低，早期肝癌丰度富集}/{}/\currentpos,
        {副拟杆菌属}/{Parabacteroides}/0.00675/{0.1095-8.7303}/9\%/95.19\%/偏低/{帮助调脂代谢，改善脂肪肝病，产生强大的降解酶，参与胆碱代谢，顺产宝宝和长寿老人肠道丰富，过多会导致菌群紊乱，过敏性鼻炎患者增加，生酮饮食、铁皮石斛，玉米纤维可增加其丰度}/{建议：抗性淀粉、二甲双胍或白藜芦醇}/\currentpos,
        {另枝菌属}/{Alistipes}/0.00099/{0.0807-18.1199}/15\%/91.83\%/偏低/{耐胆汁酸菌，丙酸，乙酸生产者，参与原敏途径产生氨、H2S、甲酸、吲哚和苯酚，诱发溃疡性结肠炎，肝纤维化，心房颤动，自闭症患者减少，抑郁，焦虑患者增加，丰度增加可能与GABA的增加相关}/{建议：高脂饮食、动物性饮食、高糖饮食和肥胖、高蛋白饮食、咖啡酸和白藜芦醇}/\currentpos,
        {毛螺菌属}/{Lachnospira}/5.02851/{0.0347-8.6596}/70\%/88.94\%/正常/{基石菌，发酵代谢肠道纤维，利用果蔬果胶产生乙酸，丁酸，与睡眠质量呈负相关，过少与多种疾病相关，哮喘、过敏、认知障碍、系统性红斑狼疮、甲状腺功能亢进、II型糖尿病相关}/{}/\currentpos,
        {考拉杆菌属}/{Phascolarctobacterium}/0.00081/{0-3.7492}/15\%/88.94\%/正常/{东方人肠道的软心菌属，高易减肥，与水果蔬菜摄入相关，随年龄增加，在通度抑郁、阿尔茨海默病(AD)、自闭症富集，利用碳铝酸的细菌缓解肥胖，阻止鸡蛋岭固定植，低聚果糖会降低其丰度，与抗杆菌，肠道菌群有关有助于维持平衡的菌群}/{}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {巨单胞菌属}/{Megamonas}/0.00049/{0-0.6916}/58\%/87.50\%/正常/{发酵各种碳水化合物，产乙酸、丙酸、乳酸，自闭症谱系障碍、注意缺陷、多动障碍（ADHD）急性脑卒中（AIS）较对照增高，减少与虚弱，炎症肠病，营养不良有关}/{建议：增加饮食中豆类、玉米、马铃薯、鸡肉、牛肉的摄入}/\currentpos,
        {粪球菌属}/{Coprococcus}/0.05595/{0.0826-9.4195}/64\%/86.06\%/偏低/{可产丁酸，抑制免疫反应，降低过敏，抑郁、帕金森、认知障碍便秘，慢性肾病、虚弱者减少，过多导致菌群失衡，与体重、总胆固醇和甘油三酯的变化呈正相关}/{建议：菊粉、大麦、阿拉伯木聚糖低聚糖、抗性淀粉、维生素D、二甲双胍}/\currentpos,
        {双歧杆菌属}/{Bifidobacterium}/0.03296/{1.7546-35.5006}/24\%/97.12\%/偏低/{最重要的益生菌，基石菌，维持肠道菌群平衡，合成B族维生素，γ-氨基丁酸(GABA)，产乙酸、有机酸、抗菌肽和抑制病原菌，抗感染，提高免疫，抗肿瘤，多种疾病发生和进展期丰度减少，关叉喂养菌，丰度高体重较轻，过高会导致菌群紊乱}/{建议：益生菌补充、发酵食品、低聚果糖，抗性淀粉，白藜芦醇、镁、绿茶、岩藻多糖、大麦、菊芋、阿拉伯木聚糖、菊粉、减少饮酒}/\currentpos,
        {乳杆菌属}/{Lactobacillus}/0.00660/{0-0.4302}/8\%/91.83\%/正常/{婴幼儿较多，益生菌，消化和代谢蛋白质和碳水化合物，合成B族维生素和维生素K，分解代谢胆汁盐，改善消化缓解过敏，增强免疫，抑制炎症，降低胆固醇，抗菌，丰度过高体重增加，也有机会病原体，过高会导致菌群失调}/{}/\currentpos,
        {芽孢杆菌属}/{Bacillus}/ND/{0.0001-0.5535}/27\%/77.88\%/未检出/{革兰氏阳性菌，自闭症儿童显著较高，可能与短链脂肪酸较高有关，部分菌种有益（例如，枯草芽孢杆菌，凝结芽孢杆菌，克劳氏芽孢杆菌），部分条件致病菌（蜡样芽孢杆菌，炭疽杆菌），过多致病，导致菌群失衡}/{建议：母乳低聚糖}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {图里希菌属}/{Turicibacter}/0.00252/{0-0.1234}/-\%/49.52\%/正常/{发酵生成乳酸，参与肌肉和疲劳调节。在肠道中发挥重要作用，与运动和肌肉代谢相关。丰度变化可能影响体能和肌肉功能。}/{}/\currentpos,
        {丁酸弧菌属}/{Butyrivibrio}/0.02421/{0-3.2594}/98\%/35.58\%/正常/{利用纤维素、淀粉和其他多聚糖生成丁酸。是重要的丁酸产生菌，参与碳水化合物代谢，维持肠道健康。产生的丁酸对肠道屏障功能和免疫系统有重要作用。}/{}/\currentpos,
        {克里斯滕森菌属}/{Christensenella}/0.00192/{0-0.0054}/83\%/5.77\%/正常/{与健康长寿相关的重要菌群，可能与代谢健康和体重控制有关。遗传性较强，被认为是最具遗传性的肠道菌群之一。在健康人群中普遍存在但丰度较低。}/{}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {嗜粘蛋白-艾克曼菌}/{A. muciniphila}/0.00394/{0-6.6395}/27\%/95.67\%/丰度较低/{肠道益生菌，维护肠黏膜健康。参与肠道屏障功能的维护，与代谢健康密切相关。}/{}/\currentpos,
        {凝结芽孢杆菌}/{Bacillus coagulans}/0.00027/{0-0.08}/15\%/88.94\%/丰度较低/{益生菌，改善消化功能。能够产生乳酸，具有良好的耐受性，可以改善肠道环境。}/{}/\currentpos,
        {枯草芽孢杆菌}/{Bacillus subtilis}/0.00185/{0-0.08}/58\%/87.50\%/丰度较低/{益生菌，增强免疫力。产生多种有益物质，具有较强的环境适应能力。}/{}/\currentpos,
        {多形拟杆菌}/{Bacteroides thetaiotaomicron}/0.00020/{0-2.7856}/64\%/86.06\%/丰度较低/{肠道共生菌，参与营养代谢。对复杂碳水化合物的分解具有重要作用。}/{}/\currentpos,
        {青春双歧杆菌}/{Bifidobacterium adolescentis}/ND/{0-14.286}/24\%/97.12\%/未检出/{益生菌，调节肠道菌群。是成年人肠道中最主要的双歧杆菌之一。}/{建议补充益生菌制剂}/\currentpos,
        {角双歧杆菌}/{Bifidobacterium angulatum}/ND/{0-0.15257}/8\%/91.83\%/未检出/{益生菌，维护肠道健康。参与碳水化合物的代谢，产生有益的代谢产物。}/{建议补充益生菌制剂}/\currentpos
%        {动物双歧杆菌}/{Bifidobacterium animalis}/0.00113/{0-0.18833}/27\%/77.88\%/丰度较低/{益生菌，改善肠道功能。具有良好的耐受性，常用于发酵乳制品。}/{}/\currentpos,
%        {两歧双歧杆菌}/{Bifidobacterium bifidum}/ND/{0-2.1225}/8\%/98.56\%/未检出/{重要益生菌，增强免疫力。对婴幼儿肠道健康特别重要。}/{建议补充益生菌制剂}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {动物双歧杆菌}/{Bifidobacterium animalis}/0.00113/{0-0.18833}/27\%/77.88\%/丰度较低/{益生菌，改善肠道功能。具有良好的耐受性，常用于发酵乳制品。}/{}/\currentpos,
        {两歧双歧杆菌}/{Bifidobacterium bifidum}/ND/{0-2.1225}/8\%/98.56\%/未检出/{重要益生菌，增强免疫力。对婴幼儿肠道健康特别重要。}/{建议补充益生菌制剂}/\currentpos,
        {短双歧杆菌}/{Bifidobacterium breve}/0.00158/{0-0.08}/67\%/99.52\%/丰度较低/{益生菌，抑制有害菌。对维持肠道菌群平衡具有重要作用。}/{}/\currentpos,
        {链状双歧杆菌}/{Bifidobacterium catenulatum}/ND/{0-0.50838}/50\%/99.52\%/未检出/{益生菌，维护肠道平衡。能够分解多种复杂碳水化合物。}/{建议补充益生菌制剂}/\currentpos,
        {乳双歧杆菌}/{Bifidobacterium crudilactis}/ND/{0-0.08}/44\%/99.52\%/未检出/{益生菌，促进营养吸收。在发酵乳制品中常见。}/{建议补充益生菌制剂}/\currentpos,
        {婴儿双歧杆菌}/{Bifidobacterium infantis}/ND/{0-0.08}/2\%/99.04\%/未检出/{婴幼儿益生菌，预防肠道感染。对婴幼儿肠道发育极其重要。}/{建议补充益生菌制剂}/\currentpos,
        {长双歧杆菌}/{Bifidobacterium longum}/0.01861/{0-6.854}/95\%/98.56\%/丰度较低/{重要益生菌，改善肠道环境。具有抗炎和免疫调节作用。}/{}/\currentpos,
        {胃痛双歧杆菌}/{Bifidobacterium merycicum}/ND/{0-0.08}/8\%/91.83\%/未检出/{益生菌，保护胃肠道。对维持胃肠道健康有重要作用。}/{建议补充益生菌制剂}/\currentpos,
        {穆卡拉巴双歧杆菌}/{Bifidobacterium moukalabense}/0.00021/{0-0.08}/27\%/77.88\%/丰度较低/{益生菌，维持菌群平衡。是较新发现的双歧杆菌种。}/{}/\currentpos,
        {假长双歧杆菌}/{Bifidobacterium pseudolongum}/0.00142/{0-0.08}/83\%/5.77\%/丰度较低/{益生菌，参与肠道代谢。对维持肠道健康有重要作用。}/{}/\currentpos,
        {分支双歧杆菌}/{Bifidobacterium ramosum}/ND/{0-0.08}/98\%/35.58\%/未检出/{益生菌，促进营养吸收。参与多种营养物质的代谢。}/{建议补充益生菌制剂}/\currentpos
%        {罗伊氏双歧杆菌}/{Bifidobacterium reuteri}/ND/{0-0.08}/83\%/5.77\%/未检出/{益生菌，具有免疫调节作用。能产生多种有益代谢物。}/{建议补充益生菌制剂}/\currentpos,
%        {短柄双歧杆菌}/{Bifidobacterium stellenboschense}/ND/{0-0.08}/27\%/77.88\%/未检出/{益生菌，参与碳水化合物代谢。维持肠道微生态平衡。}/{建议补充益生菌制剂}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {罗伊氏双歧杆菌}/{Bifidobacterium reuteri}/ND/{0-0.08}/83\%/5.77\%/未检出/{益生菌，具有免疫调节作用。能产生多种有益代谢物。}/{建议补充益生菌制剂}/\currentpos,
        {短柄双歧杆菌}/{Bifidobacterium stellenboschense}/ND/{0-0.08}/27\%/77.88\%/未检出/{益生菌，参与碳水化合物代谢。维持肠道微生态平衡。}/{建议补充益生菌制剂}/\currentpos,
        {粪双歧杆菌}/{Bifidobacterium stercoris}/ND/{0-0.08}/8\%/91.83\%/未检出/{益生菌，参与肠道代谢。对肠道健康有积极作用。}/{建议补充益生菌制剂}/\currentpos,
        {布劳特氏菌属氢营养菌}/{Blautia hydrogenotropica}/0.00262/{0-0.08}/27\%/77.88\%/丰度较低/{参与氢气代谢，维持肠道环境平衡。对肠道微生态有重要作用。}/{}/\currentpos,
        {穗状丁酸弧菌}/{Butyrivibrio crossotus}/0.00239/{0-2.9334}/8\%/91.83\%/丰度较低/{产生丁酸，维护肠道健康。参与纤维素降解。}/{}/\currentpos,
        {丁酸梭菌}/{Clostridium butyricum}/0.01350/{0-0.08}/27\%/77.88\%/丰度较低/{产生丁酸，具有益生作用。改善肠道环境。}/{}/\currentpos,
        {霍氏真杆菌}/{Eubacterium hallii}/0.02035/{0-3.5506}/8\%/91.83\%/丰度较低/{产生短链脂肪酸，维护肠道健康。参与多种代谢过程。}/{}/\currentpos,
        {直肠真杆菌}/{Eubacterium rectale}/2.14287/{0-13.029}/75\%/95.67\%/检出/{产生丁酸，维护肠道健康。参与碳水化合物代谢，具有抗炎作用。}/{}/\currentpos,
        {普拉梭菌}/{Faecalibacterium prausnitzii}/26.23325/{0.18043-14.003}/98\%/99.52\%/超标/{重要益生菌，产生丁酸。具有抗炎作用，与肠道健康密切相关。}/{建议调整饮食结构，增加膳食纤维摄入}/\currentpos,
        {嗜酸乳杆菌}/{Lactobacillus acidophilus}/ND/{0-0.08}/15\%/88.94\%/未检出/{重要益生菌，产生乳酸。改善肠道环境，增强免疫力。}/{建议补充益生菌制剂}/\currentpos,
        {短乳杆菌}/{Lactobacillus brevis}/0.00028/{0-0.08}/27\%/77.88\%/丰度较低/{益生菌，发酵乳制品常见。具有抗氧化作用。}/{}/\currentpos
%        {干酪乳杆菌}/{Lactobacillus casei}/ND/{0-0.08}/8\%/91.83\%/未检出/{益生菌，改善消化功能。增强免疫系统，维护肠道健康。}/{建议补充益生菌制剂}/\currentpos,
%        {卷曲乳杆菌}/{Lactobacillus crispatus}/0.00489/{0-0.08}/67\%/99.52\%/丰度较低/{益生菌，维持微生态平衡。产生抗菌物质，保护肠道。}/{}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {干酪乳杆菌}/{Lactobacillus casei}/ND/{0-0.08}/8\%/91.83\%/未检出/{益生菌，改善消化功能。增强免疫系统，维护肠道健康。}/{建议补充益生菌制剂}/\currentpos,
        {卷曲乳杆菌}/{Lactobacillus crispatus}/0.00489/{0-0.08}/67\%/99.52\%/丰度较低/{益生菌，维持微生态平衡。产生抗菌物质，保护肠道。}/{}/\currentpos,
        {德氏乳杆菌}/{Lactobacillus delbrueckii}/ND/{0-0.08}/44\%/99.52\%/未检出/{益生菌，发酵乳制品重要菌种。改善消化功能。}/{建议补充益生菌制剂}/\currentpos,
        {发酵乳杆菌}/{Lactobacillus fermentum}/0.00013/{0-0.08}/27\%/77.88\%/丰度较低/{益生菌，参与发酵过程。产生多种有益代谢物。}/{}/\currentpos,
        {格氏乳杆菌}/{Lactobacillus gasseri}/ND/{0-0.08}/8\%/91.83\%/未检出/{益生菌，调节免疫系统。维护肠道健康。}/{建议补充益生菌制剂}/\currentpos,
        {瑞士乳杆菌}/{Lactobacillus helveticus}/ND/{0-0.08}/44\%/99.52\%/未检出/{益生菌，发酵乳制品常见。改善营养吸收。}/{建议补充益生菌制剂}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        ...
        {韦荣菌属}/{Veillonella}/0.38326/{0-0.0086}/7\%/98.56\%/超标/{过多导致菌群失衡，也见于口腔、咽喉、呼吸道菌，健康口腔微生物菌，婴幼儿见粪便中。代谢乳酸产生丙酸可以提供运动能力，有助于微生物膜形成。}/{建议调整饮食结构，注意口腔卫生}/\currentpos,
        {泛菌属}/{Pantoea}/0.00225/{0-0.05}/-\%/0.02\%/丰度较低/{属于变形菌门肠杆菌科，条件致病菌，环境土壤、水、植物常见菌，免疫力低下，婴幼儿和老年人常检出，过多导致感染症系统，炎症和感染。}/{}/\currentpos,
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {厌氧螺菌属}/{Anaerobiospirillum}/0.00044/{0-0.05}/-\%/0.00\%/丰度较低/{引起腹泻，腹痛，常见于猫狗体内，过多会导致菌群紊乱。}/{}/\currentpos,
        {肠球菌属}/{Enterococcus}/0.12259/{0-0.05}/52\%/81.25\%/超标/{常见上呼吸道，口腔或肠道的常居菌，也分布在粪、离养殖环境、饲料或远洋中，抑菌调节肠道菌群，部分病原体引起血血症，很多耐药，在肝病，肠黏膜中富集。}/{建议调整饮食结构，注意卫生}/\currentpos,
        {奈瑟氏菌属}/{Neisseria}/0.00957/{0-0.05}/-\%/46.15\%/丰度较低/{部分为人体病原菌，口腔，咽液，鼻腔，呼吸道常菌，需氧，对干燥、热、消毒剂敏感，部分菌种产生内毒素LPS引起坏死、出血，微氧环境趋，婴幼儿易检出。}/{}/\currentpos,
        {不动杆菌属}/{Acinetobacter}/0.11947/{0-0.05}/83\%/45.19\%/超标/{条件致病菌，医院感染病原体之一，尤其ICU，易引起呼吸道感染、泌尿道感染、创伤感染，聚积不同耐药基因多重抗生素耐药，在医院环境和医院生态中重要。}/{建议加强卫生防护，避免感染}/\currentpos,
        {假单胞菌属}/{Pseudomonas}/0.07830/{0-0.05}/69\%/45.19\%/超标/{属于变形菌门，环境广泛存在，代谢多变适应力强，好氧致病菌，全导致感染和食物变质，医院致病性感染主要原因，免疫抑制个体和住院患者丰度增加。}/{建议加强卫生防护，注意环境消毒}/\currentpos,
        {霍尔德曼氏菌属}/{Holdemania}/0.10581/{0-0.0003}/98\%/29.33\%/超标/{厌氧共生菌，酵解粒蛋白，机会致病菌，少数研究表明与肠风正相关，铅含含，双向情感障碍患者富集。}/{建议进行肠道菌群调节}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {肠炎沙门氏菌}/{S. enterica ser. Enteritidis}/ND/{0-0.05}/15\%/88.94\%/未检出/{重要食源性致病菌。是沙门氏菌感染的主要原因之一。可引起急性胃肠炎。}/{注意食品卫生，避免食用未熟食品}/\currentpos,
        {副伤寒沙门氏菌-A}/{S. enterica ser. Paratyphi A}/ND/{0-0.05}/8\%/91.83\%/未检出/{人类特异性致病菌。可引起副伤寒，症状类似伤寒但较轻。}/{注意饮食卫生，预防粪-口传播}/\currentpos,
        {副伤寒沙门氏菌-B}/{S. enterica ser. Paratyphi B}/ND/{0-0.05}/15\%/88.94\%/未检出/{人类特异性病原体。引起B型副伤寒。发热和胃肠道症状显著。}/{加强个人卫生，注意饮食安全}/\currentpos,
        {副伤寒沙门氏菌-C}/{S. enterica ser. Paratyphi C}/ND/{0-0.05}/8\%/91.83\%/未检出/{致病性相对较弱的副伤寒菌。可引起C型副伤寒。}/{注意饮食卫生，避免交叉感染}/\currentpos,
        {伤寒沙门氏菌}/{S. enterica ser. Typhi}/ND/{0-0.05}/27\%/77.88\%/未检出/{严重的人类特异性病原体。可引起伤寒，威胁生命。}/{加强个人卫生，注意饮食和饮水安全}/\currentpos,
        {鼠伤寒沙门菌}/{S. enterica ser. Typhimurium}/ND/{0-0.05}/15\%/88.94\%/未检出/{广谱性致病菌。可感染多种宿主，引起急性胃肠炎。}/{注意食品安全，避免生食}/\currentpos,
        ...
        {金黄色葡萄球菌}/{Staphylococcus aureus}/0.50389/{0-0.08}/95\%/35.19\%/超标/{重要致病菌。可引起皮肤感染、食物中毒等多种疾病。需警惕。}/{及时就医诊治，注意个人卫生}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
{\small{\color{lightpurple}\faQuestionCircle}\quad \textbf{什么是肠道菌群的耐药基因？有什么临床意义？}\\
{\color{orange!50}\faComments}\quad 肠道菌群的耐药基因是指存在于肠道细菌中的一类基因，这些基因赋予细菌抵抗抗生素或其他抗菌药物的能力。
...
\node[title, anchor=east] at (7.6,0.4) {\normalsize 耐药基因}; % 调整位置以右对齐
\node[title, anchor=east] at (10,0.4) {\normalsize 耐药类型}; % 调整位置以右对齐
\node[title, anchor=east] at (12.5,0.4) {\normalsize reads数量}; % 调整位置以右对齐
\node[title, anchor=west] at (13.8,0.4) {\normalsize 具体耐药药物};

% 氨基糖苷类
\fill[customTealBg, rounded corners=5] (\margin,-0.1) rectangle (\cardwidth-\margin-6,-0.7); % 调整底部边缘
\node[category, anchor=west] at (0.6,-0.45) {氨基糖苷类抗生素耐药基因};

\foreach \bacteria/\gene/\type/\reads/\drug/\ypos in {
    ...
    \node[gene] at (7.6,\ypos) {\gene}; % 调整位置以右对齐
    \node[type] at (10,\ypos) {\type}; % 调整位置以右对齐
    \node[reads] at (12.5,\ypos) {\reads}; % 调整位置以右对齐
    \node[drug] at (13.8,\ypos) {\drug};
    \draw[rowLineColor] (\margin,\ypos-\rowspace) -- (\cardwidth-\margin,\ypos-\rowspace);
}

% β-内酰胺类
\fill[categoryColor, rounded corners=5] (\margin,-5.5) rectangle (\cardwidth-\margin-5,-6);
\node[category, anchor=west] at (0.6,-5.2) {β-内酰胺类抗生素耐药基因};
...
% 大环内酯类
\fill[categoryColor, rounded corners=5] (\margin,-6.4) rectangle (\cardwidth-\margin-5,-7.1);
\node[category, anchor=west] at (0.6,-6.75) {大环内酯类抗生素耐药基因};
...
\begin{tikzpicture}[
    ...
    \foreach \zhname/\enname/\gene/\type/\reads/\drugs/\intro/\suggestion/\pos in {
        {细菌}/{Bacterium}/{aac(6')-E111}/{\text{氨基糖苷类}}/974/{阿米卡星\\卡那霉素}/{耐药基因可能导致对氨基糖苷类抗生素产生耐药性，影响治疗效果。}/{建议在使用氨基糖苷类抗生素时进行耐药性检测。}/\currentpos,
        {细菌}/{Bacterium}/{aph(3')-IIIa}/{\text{氨基糖苷类}}/974/{阿米卡星\\卡那霉素}/{该基因能使细菌对特定氨基糖苷类抗生素产生耐药性。}/{临床用药时需注意药物选择。}/\currentpos,
        {细菌}/{Bacterium}/{aac(6')-Ie2}/{\text{氨基糖苷类}}/974/{阿米卡星\\卡那霉素}/{编码氨基糖苷修饰酶，可使细菌对多种氨基糖苷类抗生素产生耐药性。}/{建议进行药敏试验指导用药。}/\currentpos,
        {罗伊氏乳杆菌}/{Limosilactobacillus reuteri}/{aadE}/{\text{氨基糖苷类}}/76331/{链霉素}/{该基因主要与链霉素耐药相关，在乳酸菌中较为常见。}/{使用链霉素时需注意耐药情况。}/\currentpos,
        {罗伊氏乳杆菌}/{Limosilactobacillus reuteri}/{aad9}/{\text{氨基糖苷类}}/76331/{氨基糖苷类}/{能够使细菌对多种氨基糖苷类抗生素产生耐药性。}/{建议选择替代药物进行治疗。}/\currentpos,
        {大肠杆菌}/{Escherichia coli}/{npmA}/{\text{氨基糖苷类}}/8649/{氨基糖苷类}/{该基因可导致大肠杆菌对氨基糖苷类抗生素广谱耐药。}/{需进行耐药性监测和合理用药。}/\currentpos,
        {粪肠球菌}/{E. faecium EnGen0025}/{aac(6')-Ie}/{\text{氨基糖苷类}}/79765/{阿米卡星\\ 卡那霉素}/{肠球菌中的耐药基因，可导致高水平氨基糖苷类耐药。}/{建议选择替代药物或联合用药。}/\currentpos,
...
\begin{tikzpicture}[
    ...
    reference/.style={font=\scriptsize},
    cell/.style={anchor=west, text width=4.2cm, text depth=0.25ex, text height=1.5ex}, % 调整文本框高度
    gene/.style={anchor=west, text width=2.8cm, text depth=0.25ex, text height=1.5ex},
    type/.style={anchor=center, text width=2.5cm, align=center, text depth=0.25ex, text height=1.5ex},
    reads/.style={anchor=center, text width=2cm, align=center, text depth=0.25ex, text height=1.5ex},
    drug/.style={anchor=west, text width=3.5cm, text depth=0.25ex, text height=1.5ex},
    category/.style={font=\footnotesize\bfseries\color{customTeal}}
]
% \definecolor{customTeal}{RGB}{73, 175, 177}
% \definecolor{categoryColor}{RGB}{242, 247, 247}
\definecolor{categoryColor}{RGB}{230, 240, 240}
\definecolor{rowLineColor}{RGB}{230, 235, 235}
\definecolor{containerBorder}{RGB}{240, 240, 240}
...
% 标题行
\node[title, anchor=west] at (\margin,0.4) {\normalsize 来源菌株};
\node[title, anchor=west] at (4.8,0.4) {\normalsize
耐药基因};
\node[title] at (8.5,0.4) {\normalsize reads数量};
\node[title] at (11.5,0.4) {\normalsize 耐药类型};
\node[title, anchor=west] at (13.8,0.4) {\normalsize 具体耐药药物};

% 氨基糖苷类分类背景
\fill[categoryColor, rounded corners=5] (\margin,-0.2) rectangle (\cardwidth-\margin,-0.9);
\node[category, anchor=west] at (0.6,-0.55) {\small 铜/铜离子(COPPER)相关};

% 氨基糖苷类数据和行分割线
\foreach \bacteria/\gene/\type/\reads/\drug/\ypos in {
    {Enterobacteriaceae}/{silS}/{\text{氨基糖苷类}}/974/{阿米卡星/卡那霉素}/-1.3,
    {Limosilactobacillus reuteri}/{aadE}/{\text{氨基糖苷类}}/76331/{链霉素}/-2.1,
    {Escherichia coli}/{npmA}/{\text{氨基糖苷类}}/8649/{氨基糖苷类}/-2.9,
    {Enterococcus faecium EnGen0025}/{aac(6')-Ie}/{\text{氨基糖苷类}}/79765/{阿米卡星/卡那霉素}/-3.7
}
{
    \node[cell] at (\margin,\ypos) {\bacteria};
    \node[gene] at (4.8,\ypos) {\gene};
    \node[type] at (8.5,\ypos) {\type};
    \node[reads] at (11.5,\ypos) {\reads};
    \node[drug] at (13.8,\ypos) {\drug};
    \draw[rowLineColor] (\margin,\ypos+0.25) -- (\cardwidth-\margin,\ypos+0.25);
}

% β-内酰胺类分类背景
\fill[categoryColor, rounded corners=5] (\margin,-4.1) rectangle (\cardwidth-\margin,-4.8);
\node[category, anchor=west] at (0.6,-4.45) {β-内酰胺类抗生素耐药基因};

% β-内酰胺类数据和行分割线
\foreach \bacteria/\gene/\type/\reads/\drug/\ypos in {
    {Terrabacteria group}/{dfrF}/{甲氧苄啶}/28043/{甲氧苄啶}/-5.2,
    {Streptococcus sp. GMQS-10BH}/{cat414}/{氯霉素}/1446/{氯霉素}/-6.0
}
{
    \node[cell] at (\margin,\ypos) {\bacteria};
    \node[gene] at (4.8,\ypos) {\gene};
...
% 大环内酯类分类背景
\fill[categoryColor, rounded corners=5] (\margin,-6.4) rectangle (\cardwidth-\margin,-7.1);
\node[category, anchor=west] at (0.6,-6.75) {大环内酯类抗生素耐药基因};

% 大环内酯类数据和行分割线
\foreach \bacteria/\gene/\type/\reads/\drug/\ypos in {
    {Firmicutes}/{mef(A)}/{大环内酯}/1476/{阿奇霉素/红霉素}/-7.5,
    {Firmicutes}/{lnu(C)}/{林可霉素}/26567/{林可霉素}/-8.3,
    {Enterocloster clostridioformis}/{vanS-D}/{万古霉素}/746/{万古霉素}/-9.1
}
{
    \node[cell] at (\margin,\ypos) {\bacteria};
    \node[gene] at (4.8,\ypos) {\gene};
...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\status/\intro/\suggestion/\index in {
        {铁}/{Fe}/63/{0-75}/正常/{碳水化合物的一种，提供快速能量，参与代谢过程。}/{}/\currentpos,
        {锌}/{Zn}/0.00023/{0-0.01}/正常/{一种矿物质，主要成分为氯化钠。它在体内维持水分平衡、调节血压，并参与神经和肌肉的正常功能。}/{}/\currentpos,
        {乙酸}/{Dietary Fiber}/0.00145/{0-0.02}/正常/{植物性食物中的一种不可消化的碳水化合物，有助于促进肠道健康、改善消化、控制血糖水平，并降低胆固醇。}/{}/\currentpos,
        {丙酸}/{Dairy Products}/0.00567/{0-0.03}/正常/{由牛奶或其他动物的乳汁制成的食品，如牛奶、酸奶和奶酪。它们是钙、蛋白质和维生素D的重要来源，有助于骨骼健康和肌肉生长。}/{}/\currentpos,
        {丁酸}/{Dairy Products}/0.00567/{0-0.03}/正常/{由牛奶或其他动物的乳汁制成的食品，如牛奶、酸奶和奶酪。它们是钙、蛋白质和维生素D的重要来源，有助于骨骼健康和肌肉生长。}/{}/\currentpos
    }
    {
        % 计算当前行的基础位置
        \pgfmathsetmacro{\basepos}{-2.8*\currentpos}
...
{\small{\color{customTeal}\faInfoCircle} 维生素是人体必需的微量营养素，本报告通过肠道菌群等检测指标来评估下列维生素的水平。
}
\end{tcolorbox}
\vspace{-0.5cm}
\begin{center}
...
\item 相关性不等同于因果关系
\item 同一菌群可能与多种症状相关
\item 症状可能同时涉及多个菌群的变化
\end{itemize}
\end{itemize}
\textbf{注意事项}
\begin{itemize}[]
\item 超标提示：菌群丰度超出正常范围，提示存在异常
\item 综合考虑：需结合个人症状和临床检查综合判断
\item 动态监测：建议定期复查，观察菌群变化趋势
\item 个体差异：考虑年龄、性别、地域等个体因素影响
\end{itemize}
}
\end{tcolorbox}
...
%\textbf{关键菌群作用}
%\begin{itemize}[]
%\item 厚壁菌门：增高与肥胖相关，提高热量吸收
%\item 拟杆菌门：降低与肥胖相关，减少能量收获
%\item 阿克曼氏菌：维护肠道屏障，改善代谢功能
%\item 双歧杆菌：调节免疫功能，改善代谢状态
%\end{itemize}
%
%\textbf{改善建议}
%\begin{itemize}[]
%\item 增加膳食纤维摄入，调节菌群结构
%\item 控制高脂高糖饮食，避免菌群失衡
%\item 适量运动，促进有益菌生长
%\item 合理使用益生菌，改善肠道环境
%\end{itemize}
}
