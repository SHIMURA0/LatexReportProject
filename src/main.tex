...
\begin{tikzpicture}[
    ...
    % 数据行和卡片
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        {粪杆菌属}/{Faecalibacterium}/28.86665/{1.9351-17.7942}/99\%/98.08\%/超标/{粪杆菌属属于拟杆菌科，能够有效分解复杂的多糖和纤维，帮助宿主消化和吸收营养，产生短链脂肪酸（如乙酸、丙酸、丁酸），有助于维持肠道健康。}/{建议：乳杆菌补充、亚麻籽、壳聚糖、柿子糖（甜栗）}/\currentpos,
...
\begin{tikzpicture}[
    ...
    \foreach \item/\enitem/\value/\range/\percentile/\detection/\status/\intro/\suggestion/\index in {
        ...
        {普拉梭菌}/{F. prausnitzii}/26.23325/{0.18043-14.003}/98\%/99.52\%/超标/{普拉梭菌是一种益生菌，以其产生丁酸和抗炎作用而著称，对维持肠道健康和整体免疫功能有重要的积极影响。}/{建议调整饮食结构，增加膳食纤维摄入}/\currentpos,
