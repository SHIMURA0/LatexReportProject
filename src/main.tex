...
%\setCJKmainfont{Microsoft YaHei-Regular}
...
%            \textcolor{customTeal}{\textbf{\fontsize{36}{43}\selectfont 宏基因组检测报告}}
            \textcolor{customTeal}{\fontspec{\chapter*{Microsoft YaHei Bold}}\fontsize{40}{48}\selectfont\textbf{\textsf{\bfseries 宏基因组检测报告}}}
...
{\Large\bfseries\textcolor{customTeal}{\Huge 宏基因组报告阅读指南}}
\end{tcolorbox}
